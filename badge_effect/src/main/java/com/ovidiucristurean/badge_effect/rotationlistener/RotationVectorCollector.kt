package com.ovidiucristurean.badge_effect.rotationlistener
...
class RotationVectorCollector(
    ...
    private val collectionHandler: Handler
) : SensorEventListener {
    ...
    fun registerForUpdates() {
        sensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR)
            ?.let { sensorManager.registerListener(this, it, 100, collectionHandler) }
    }
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        Log.d(
            "TAG",
            "Received sensor ${event.sensor.type}, values: ${-mOrientationS[1]}, ${mOrientationS[2]}, ${mOrientationS[0]}"
        )
